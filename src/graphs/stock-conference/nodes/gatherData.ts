...
const AGENTS = [
  ...
  { key: "coreFinance", agent: financeSubagent },
  { key: "coreNews", agent: newsSubagent },
] as const;
...
export const gatherData = async (input: { state: ConferenceState }) => {
  ...
  return { state: { ...state, gatheringComplete: true, rawData: rawData as unknown as RawDataCollection } };
};